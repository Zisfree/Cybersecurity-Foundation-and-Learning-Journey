...
### I have deleted the one I made earlier cause I did not make it a md file 😅
...
If it asks the pass just type anything and enter. Ftp is not at all complicated to use. Just find the item you need by typing ls or something else u prefer and when u find it type get with that files name.
