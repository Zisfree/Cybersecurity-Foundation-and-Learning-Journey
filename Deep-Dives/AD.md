## Active directory:
- Let's say there are 100+ systems and with 150+ users. How will someone manage them?
- To manage the passwords and usernames of each and every person, to login into easily we use AD.
- Active Directory is basically a storage and management server. It is used to store the stuff regarding passwords and other small or trivial things to make a big corporate's security and stability.
- There are few objects supported by AD like, users, machines and security groups.
